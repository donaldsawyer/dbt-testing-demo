...
{% call dbt_unit_testing.test('gld_flight', 'validates transformation logic for gold.flight') %}
    ...
    {% call dbt_unit_testing.mock_ref('slv_flight') %}
        YEAR    | MONTH | dayOfMonth    | flightDate    | flightNumber  | carrier   | origin    | destination   | departureDelayMinutes
        ...
        2000    | 0     | NULL          | NULL          | 000000        | 'C1X'     | 'X01'     | 'X10'         | NULL
        2000    | 13    | NULL          | NULL          | 000000        | 'C1X'     | 'X01'     | 'X10'         | NULL
        1899    | NULL  | NULL          | NULL          | 000000        | 'C1X'     | 'X01'     | 'X10'         | NULL
        0       | NULL  | NULL          | NULL          | 000000        | 'C1X'     | 'X01'     | 'X10'         | NULL
        2000    | 1     | 32            | NULL          | 000000        | 'C1X'     | 'X01'     | 'X10'         | NULL
        2000    | 1     | 0             | NULL          | 000000        | 'C1X'     | 'X01'     | 'X10'         | NULL
    {% endcall %}
